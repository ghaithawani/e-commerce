 ...
 */
final class Version20240508211059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livraison (idlivraison INT AUTO_INCREMENT NOT NULL, id_vehicule INT DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, destinataire VARCHAR(255) DEFAULT NULL, datelivraison DATE DEFAULT \'NULL\', INDEX fk_idvehicule (id_vehicule), PRIMARY KEY(idlivraison)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produits (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, description VARCHAR(255) DEFAULT NULL, categorie VARCHAR(255) DEFAULT NULL, dateajout DATE DEFAULT NULL, INDEX IDX_BE2DDF8CF347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE produits ADD CONSTRAINT FK_BE2DDF8CF347EFB FOREIGN KEY (produit_id) REFERENCES produits (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits DROP FOREIGN KEY FK_BE2DDF8CF347EFB');
